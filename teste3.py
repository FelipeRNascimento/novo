    ...
    def cursos(self):
        ...
        while True:
            if turmas == 'S':
                ...
                self.nomes_cursos.append(nova_turma)
    ...
    def identificado(self):
        ...
        while True:
            if alunos == 'S':
                ...
                self.nomes_alunos.append(novo_nome)
...
print("Os alunos disponíveis são", v_identificado.nomes_alunos)
print("As turmas disponíveis são", v_cursos.nomes_cursos)
